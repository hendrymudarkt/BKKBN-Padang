...
<script type="text/javascript">
	$(document).ready(function () {
		...
		function tampil_data_pengguna() {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo site_url("dokumen/data_operasional_others") ?>',
				async: false,
				dataType: 'json',
				success: function (data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							data[i].id_dokumen +
							'" class="btn btn-icon btn-sm btn-primary item_pdf"><i class="far fa-eye"></i></a>'
							'</td>' +
							'</tr>';
						<?php } else { ?>
							html += '<tr>' +
							...
							data[i].id_dokumen +
							'" class="btn btn-icon btn-sm btn-primary item_pdf"><i class="far fa-eye"></i></a> </td>' +
							'<td>' + data[i].owner + '</td>' +
							'</tr>';
						<?php } ?>
					}
