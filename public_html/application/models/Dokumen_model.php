...
class Dokumen_model extends CI_Model{
	...
	function get_kategori($divisi, $jenis, $kategori){
        return $this->db->get_where('dokumen',array('divisi'=>$divisi, 'jenis_dokumen'=>$jenis, 'kategori'=>$kategori))->result_array();
    }
	...
	function update_dokumen2($id, $judul, $tanggal, $divisi, $jenis_dokumen, $kategori, $owner){
		$this->db->set('judul', $judul);
		$this->db->set('tanggal', $tanggal);
