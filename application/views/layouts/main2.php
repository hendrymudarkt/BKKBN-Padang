            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('dashboard/notaris');?>">
                                <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                            </a>
                        </li>
						<li>
                            <a href="<?php echo site_url('laporan/masuk');?>">
                                <i class="fa fa-copy"></i> <span>Surat Masuk</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('laporan/Keluar');?>">
                                <i class="fa fa-copy"></i> <span>Surat Keluar</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('laporan/rekap');?>">
                                <i class="fa fa-star-o"></i> <span>Rekap Surat</span>
                            </a>
                        </li>
                    </ul>
                </section>
