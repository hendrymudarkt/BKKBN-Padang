<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('karyawan/edit/'.$karyawan['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
	                  <label for="nip" class="control-label">NIP</label>
	                  <div class="form-group">
	                    <input type="text" name="nip" value="<?php echo $karyawan['nip'] ?>" class="form-control" />
	                  </div>
	                </div>
	                <div class="col-md-6">
	                  <label for="nama" class="control-label">Nama</label>
	                  <div class="form-group">
	                    <input type="text" name="nama" value="<?php echo $karyawan['nama'] ?>" class="form-control" />
	                  </div>
	                </div>
	                <div class="col-md-6">
	                  <label for="npwp" class="control-label">NPWP</label>
	                  <div class="form-group">
	                    <input type="text" name="npwp" value="<?php echo $karyawan['npwp'] ?>" class="form-control" />
	                  </div>
	                </div>
	                <div class="col-md-6">
	                  <label for="no_telp" class="control-label">No Telp</label>
	                  <div class="form-group">
	                    <input type="text" name="no_telp" class="form-control" value="<?php echo $karyawan['no_telp'] ?>" />
	                  </div>
	                </div>
	                <div class="col-md-6">
	                  ...
	                  <div class="form-group">
	                    <select name="jk" class="form-control">
	                      <option value="<?php echo $karyawan['jk'] ?>"><?php echo $karyawan['jk'] ?></option>
	                ...
	                <div class="col-md-6">
	                  ...
	                  <div class="form-group">
	                    <input type="text" name="alamat" value="<?php echo $karyawan['alamat'] ?>" class="form-control" />
	                  </div>
	                </div>
	                <div class="col-md-6">
	                ...
	                <div class="col-md-6">
	                  ...
	                  <div class="form-group">
	                    <select name="golongan" class="form-control">
	                      <option value="<?php echo $karyawan['golongan'] ?>"><?php echo $karyawan['golongan'] ?></option>
